...
htmltools::HTML(
  paste0("<style>
  :root {
    --report-main-color: ", params$maincolor, " !important;
  }
  </style>")
)
```
...
<div style="color: #737373;">`{r} htmltools::a(paste0("Source: ", species_content$source_name), href = species_content$source, style="color: #737373; text-decoration: none;")`<span class="material-symbols-outlined">arrow_outward</span></div>
...
<div style="display: flex; flex-direction: row; justify-content: space-between;"><span style=" font-size: 26px; font-weight: bold; color: white;">`{r} htmltools::a("WoRMS", href = paste0("https://www.marinespecies.org/aphia.php?p=taxdetails&id=", species_data$aphiaID[1]), style="color: white; text-decoration: none;")`</span><span class="material-symbols-outlined" style="color: white; font-size: 36px;">arrow_outward</span></div>
...
ggplot() +
  geom_bar(data = sst, aes(x = as.factor(parameter), y = records), stat = "identity", fill = "#004aad") +
    scale_x_discrete(
        labels = paste(sst$parameter, sst$parameter + diff(sst$parameter[1:2]), sep = "-")
    ) +
#  geom_histogram(aes(x = sst), fill = "#004aad", color = "white", linewidth = 0.1, binwidth = 1) +
#  geom_linerange(
...
#| fig-align: center
ggplot() +
  geom_bar(data = sss, aes(x = as.factor(parameter), y = records), stat = "identity", fill = "#004aad") +
    scale_x_discrete(
...
#| fig-align: center
ggplot() +
  geom_bar(data = depth, aes(x = as.factor(parameter), y = records), stat = "identity", fill = "#004aad") +
    scale_x_discrete(
...
::: {.g-col-5 style="background-color: #f8f8f8; padding-top: 30px; padding-bottom: 10px; padding-left: 40px; min-height: 260px; padding-right: 40px;"}
...
<div style="display: flex; flex-direction: row; justify-content: space-between;"><span style=" font-size: 36px; font-weight: bold; color: white;">`{r} htmltools::a("OBIS", href = paste0("https://obis.org/taxon/", species_data$aphiaID[1]), style="color: white; text-decoration: none;")`</span><span class="material-symbols-outlined" style="color: white; font-size: 52px;">arrow_outward</span></div>
